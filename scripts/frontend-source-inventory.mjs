...
const OWNERSHIP = new Map([
  ...
  [
    ...
    {
      responsibility:
        "Render a queue row and forward selection, filename, and download actions.",
  ...
  [
    ...
    {
      responsibility:
        "Compose the queue viewport, table controls, and virtual rows.",
      workflows: ["queue", "download", "accessibility"],
    },
  ],
  [
    ...
    {
      responsibility:
        "Render queue and diagnostic actions with their existing admission states.",
  ...
  [
    ...
    {
      responsibility:
        "Render version, readiness, maintenance, and update controls.",
  ...
  [
    ...
    {
      responsibility:
        "Render the playlist picker and own its local select-all DOM reference.",
  ...
  [
    ...
    {
      responsibility:
        "Render update details and forward update and dismissal actions.",
  ...
  [
    "src/lib/queue-presentation-helpers.ts",
    {
      responsibility:
        "Project authoritative queue records and format queue display state without side effects.",
      workflows: ["queue", "download", "state-sync"],
    },
  ],
  [
