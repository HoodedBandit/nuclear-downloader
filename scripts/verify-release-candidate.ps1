...
if ($ExpectedVersion -cne '0.7.9') {
    throw 'This verification contract is intentionally pinned to release 0.7.9.'
}
...
if ($legacyActual -cne $legacyExpected) {
    throw 'The v0.5.4 bridge checksum does not exactly bind the 0.7.9 installer.'
}
